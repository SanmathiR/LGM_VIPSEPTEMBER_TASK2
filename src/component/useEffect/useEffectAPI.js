...
const UseEffectAPI = () => {
    ...
    return (
        ...
        <div>
                ...
                <div className="container">
                    <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                            <li><a href="#" className="nav-link px-8">LetsGrowMore</a></li>
                        </ul>
            ...
            <div className="main">
                <h4 className="animate">Click the Get Users button to view user's profile</h4>
            </div>
                                        ...
                                        <div className="row g-0">
                                            ...
                                            <div className="col-md-8">
                                                <div className="card-body">
                                                    ...
                                                    <p className="textcard1"><small> {curElem.first_name}   {curElem.last_name}</small></p>
                                                    <p className="textcard2"> <a href="#">{curElem.email}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
